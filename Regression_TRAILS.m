...
for CV_idx = 1 : KFold_Num
   ...
   for Mdl_idx = 1 : size(X_TRAILS,2)-1
    ...
    RMSE_SVR_avg_TRAILS = mean(RMSE_SVR,3);
    Std_SVR_avg_TRAILS  = std(RMSE_SVR,0,3);
    RMSE_LR_avg_TRAILS  = mean(RMSE_LR,3);
    Std_LR_avg_TRAILS   = std(RMSE_LR,0,3);
    RMSE_RR_avg_TRAILS  = mean(RMSE_RR,3);
    Std_RR_avg_TRAILS   = std(RMSE_RR,0,3);
    RMSE_Lasso_avg_TRAILS = mean(RMSE_Lasso,3);
    Std_Lasso_avg_TRAILS  = std(RMSE_Lasso,0,3);


    save('R_VBM_TRAILS.mat','RMSE_SVR_avg_TRAILS','RMSE_LR_avg_TRAILS','RMSE_RR_avg_TRAILS','RMSE_Lasso_avg_TRAILS',...
          'Std_SVR_avg_TRAILS','Std_LR_avg_TRAILS','Std_RR_avg_TRAILS','Std_Lasso_avg_TRAILS',...
